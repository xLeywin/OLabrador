            ...
            <ItemTemplate>
                <asp:HyperLink ID="PostLink" runat="server" CssClass="no-decoration">
                    <div class="col-12 box border padding-14">
                        <div class="row">
                            <div class="col-4">
                                <asp:Image Width="100%" ID="Image" runat="server" CssClass="borda-imagem margin-top-20" />
                            </div>
                            <div class="col-8">
                                <asp:Label ID="Title" Font-Size="30px" runat="server" Font-Bold="true" CssClass="body-titulo"></asp:Label>
                                <br />
                                <asp:Label ID="Subtitle" Font-Size="25px" runat="server"></asp:Label>
                                <br />
                                <asp:Label ID="PostDate" Font-Size="20px" runat="server"></asp:Label>
                            </div>
                        </div>
                    </div>
                </asp:HyperLink>
